...
if (!(test-path alias:pycharm)) {New-Alias -Name pycharm -Value 'C:\Program Files (x86)\JetBrains\PyCharm Community Edition 2018.1.3\bin\pycharm64.exe'}
$me = $env:USERPROFILE
$downloads = 'G:\My Drive\MyProfile'
